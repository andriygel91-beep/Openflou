...
const baseTranslations = {
  ...
  noFriendsDesc: 'Search by username to add friends',
...
export const translations: Record<Language, typeof baseTranslations> = {
  ...
  ru: {
    ...
    noFriendsDesc: 'Найдите пользователей по имени',
    searchUsers: 'Найти по @юзернейму',
    searchResultsTitle: 'Результаты поиска',
    notFound: 'Пользователь не найден',
    groupCall: 'Групповой звонок',
    startGroupCall: 'Начать групповой звонок',
  ...
  uk: {
    ...
    savedMessages: 'Вибране',
    noFriends: 'Немає друзів',
    noFriendsDesc: 'Знайдіть користувачів за іменем',
    searchUsers: 'Знайти по @юзернейму',
    searchResultsTitle: 'Результати пошуку',
    notFound: 'Користувача не знайдено',
    groupCall: 'Груповий дзвінок',
    startGroupCall: 'Почати груповий дзвінок',
    pushNotificationsEnabled: 'Push-сповіщення увімкнено',
    pushNotificationsDisabled: 'Push-сповіщення вимкнено',
